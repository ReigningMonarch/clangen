...
class Pelt:
    ...
    eye_colours = ['SUNLITICE', 'LEMON', 'YELLOW', 'CITRINE', 'HONEY', 'SUNFLOWER', 'GOLD', 'MARIGOLD', 'PEACH', 'ORANGE', 'JASPER', 'COPPER', 'CORAL', 'AMBER', 'BRONZE', 
        'CRIMSON', 'FEATHER', 'BRASS', 'BROWN', 'CHOCOLATE', 'LIME', 'KIWI', 'PEAR', 'APPLE', 'PERIDOT', 'GREEN', 'CLOVER', 'FERN', 'JADE', 'SHAMROCK', 'EMERALD', 
        'FOREST', 'MINT', 'SPRING', 'OCEAN', 'JUNGLE', 'SAGE', 'LAUREL', 'PISTACHIO', 'MOSS', 'MIST', 'CYAN', 'AQUA', 'TURQUOISE', 'SAPPHIRE', 'DOLPHIN', 'DUCK', 
        'TEAL', 'ARCTIC', 'SKY', 'EGG', 'CERULEAN', 'CORNFLOWER', 'BERRY', 'AZURE', 'BLUE', 'LAPIS', 'COBALT', 'NAVY', 'MIDNIGHT', 'IRIS', 'SLATE', 'ULTRAMARINE', 
        'INDIGO', 'PERIWINKLE', 'HEATHER', 'VIOLET', 'AMETHYST', 'SILVER', 'GREY', 'STONE', 'METAL', 'SWAMP', 'ASPARAGUS', 'OLIVE', 'HAZEL', 'PINK', 'PURPLE', 'ICE', 
        'BLACK']
    yellow_eyes = ['SUNLITICE', 'LEMON', 'YELLOW', 'CITRINE', 'HONEY', 'SUNFLOWER', 'GOLD', 'MARIGOLD', 'PEACH', 'ORANGE', 'JASPER', 'COPPER', 'CORAL', 'AMBER', 'BRONZE', 
        'CRIMSON', 'FEATHER', 'BRASS', 'BROWN', 'CHOCOLATE', 'PINK', 'SWAMP', 'ASPARAGUS', 'OLIVE', 'HAZEL']
    blue_eyes = ['MIST', 'CYAN', 'AQUA', 'TURQUOISE', 'SAPPHIRE', 'DOLPHIN', 'DUCK', 'TEAL', 'ARCTIC', 'SKY', 'EGG', 'CERULEAN', 'CORNFLOWER', 'BERRY', 'AZURE', 'BLUE', 
        'LAPIS', 'COBALT', 'NAVY', 'MIDNIGHT', 'IRIS', 'SLATE', 'ULTRAMARINE', 'INDIGO', 'PERIWINKLE', 'HEATHER', 'VIOLET', 'AMETHYST', 'SILVER', 'GREY', 
        'STONE', 'METAL', 'PURPLE', 'ICE', 'BLACK']
    green_eyes = ['LIME', 'KIWI', 'PEAR', 'APPLE', 'PERIDOT', 'GREEN', 'CLOVER', 'FERN', 'JADE', 'SHAMROCK', 'EMERALD', 'FOREST', 'MINT', 'SPRING', 'OCEAN', 'JUNGLE', 
        'SAGE', 'LAUREL', 'PISTACHIO', 'MOSS']
    ...
    wild_accessories = ['ORANGEBUTTERFLY', 'WHITEPOINSETTIA', 'MUD', 'JAYFEATHER', 'EGGSHELLS', 'FLOWERCROWN', 'STICKS', 'ASHY PAWS', 'CORALBELLS', 'SMALL LUNA', 'LILY', 'BLUEEGGSHELLS', 'CHERRYPLUMLEAVES', 'BROWNPELT', 'MORPHO BUTTERFLY', 'SPRINGFEATHERS', 'WOODENBIRCHANTLERS', 'DOGWOOD', 'REDCROWN', 'LADYBUG', 'GULL FEATHERS', 'EASTEREGG', 'HONEYCOMB', 'DRIEDORANGE', 'FIRBRANCHES', 'BLACK CICADA', 'GRAYPELT', 'LILIESOFTHEVALLEY', 'MONARCH BUTTERFLY', 'FORSYTHIA', 'WHITEWOOL', 'WOODDRAGON', 'YEWS', 'MUD PAWS', 'SPARROW FEATHERS', 'LARGE COMET', 'SANVITALIAFLOWERS', 'HEATHER', 'YELLOWCROWN', 'ROSY MOTH WINGS', 'TEETHCOLLAR', 'CREAMWOOL', 'SNAILSHELL', 'JAY FEATHERS', 'MINTLEAF', 'STRAWMANE', 'CHERRYBLOSSOM', 'MISTLETOE', 'ROESKULL', 'BELLFLOWERS', 'WOODENOAKANTLERS', 'EAGLEFEATHER', 'CATKIN', 'CICADA WINGS', 'BROWNMOSSPELT', 'LARGE LUNA', 'LILYPADCROWN', 'BLEEDINGHEART', 'TULIPPETALS', 'COTONEASTERWREATH', 'RED FEATHERS', 'EGG', 'BLUE FEATHERS', 'SMALL COMET', 'BLUEBUTTERFLY', 'MOREFERN', 'MOTH WINGS', 'REDPOINSETTIA', 'CLOVERFLOWER', 'SLIVERDUSTPLANT', 'PANSIES', 'GRAYMOSSPELT', 'BLACKWOOL', 'GRAYWOOL', 'FERN', "STARFLOWERS", "HEARTLEAVES", "YELLOWWISTERIA", "LAVENDERHEADPIECE", "LAVENDERANKLET", "LAVENDERTAILWRAP", "HOLLY2", "HOLLYVINES", "STOAT"]
    ...
    crafted_accessories = ["WILLOWBARK BAG", "CLAY DAISY POT", "CLAY AMANITA POT", "CLAY BROWNCAP POT", "BIRD SKULL", "LEAF BOW", "RAINCOAT", "POPTABS", "FAZBEAR", "WHITEBEAR", "PANDA", "BEAR", "BROWNBEAR", "TIDE", "CELESTIALCHIMES", "LUNARCHIMES", "STARCHIMES", "SILVERLUNARCHIMES", "FIDDLEHEADS", "LANTERNS", "HEARTCHARMS", "CHIMES", "BATHARNESS", "TOAST"]
    ...
    eye_sprites = [
        'SUNLITICE', 'LEMON', 'YELLOW', 'CITRINE', 'HONEY', 'SUNFLOWER', 'GOLD', 'MARIGOLD', 'PEACH', 'ORANGE', 'JASPER', 'COPPER', 'CORAL', 'AMBER', 'BRONZE', 
        'CRIMSON', 'FEATHER', 'BRASS', 'BROWN', 'CHOCOLATE', 'LIME', 'KIWI', 'PEAR', 'APPLE', 'PERIDOT', 'GREEN', 'CLOVER', 'FERN', 'JADE', 'SHAMROCK', 'EMERALD', 
        'FOREST', 'MINT', 'SPRING', 'OCEAN', 'JUNGLE', 'SAGE', 'LAUREL', 'PISTACHIO', 'MOSS', 'MIST', 'CYAN', 'AQUA', 'TURQUOISE', 'SAPPHIRE', 'DOLPHIN', 'DUCK', 
        'TEAL', 'ARCTIC', 'SKY', 'EGG', 'CERULEAN', 'CORNFLOWER', 'BERRY', 'AZURE', 'BLUE', 'LAPIS', 'COBALT', 'NAVY', 'MIDNIGHT', 'IRIS', 'SLATE', 'ULTRAMARINE', 
        'INDIGO', 'PERIWINKLE', 'HEATHER', 'VIOLET', 'AMETHYST', 'SILVER', 'GREY', 'STONE', 'METAL', 'SWAMP', 'ASPARAGUS', 'OLIVE', 'HAZEL', 'PINK', 'PURPLE', 'ICE', 
